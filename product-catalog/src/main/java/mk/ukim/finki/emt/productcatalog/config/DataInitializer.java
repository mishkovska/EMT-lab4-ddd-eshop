...
public class DataInitializer {
    ...
    public void initData() {
        Product p1 = Product.build("Golden Case", "Golden Case Description", 10, Money.valueOf(Currency.MKD, 500));
        Product p2 = Product.build("Pink Case", "Pink Case Description", 5, Money.valueOf(Currency.MKD, 100));
